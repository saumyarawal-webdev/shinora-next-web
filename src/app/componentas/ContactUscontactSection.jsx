              ...
              <div className="row">
                <div className="col-md-11">
                  ...
                  <div className="contact-item mb-30 mb-sm-20">
                    ...
                    <div>
                      <a
                        href="https://maps.app.goo.gl/9nf19TFn1EKV3JBN6"
                        className="link-hover-anim"
                        data-link-animate="y"
                        rel="nofollow noopener"
                        target="_blank"
                      >
                        See Map <i className="mi-arrow-right size-18" />
                      </a>
                    </div>
                  </div>
                  {/* End Address */}
                  ...
                  <div className="contact-item mb-30 mb-sm-20">
                    ...
                    <div>
                      <a
                        href="mailto:appointment@shinora.in"
                        className="link-hover-anim"
                        data-link-animate="y"
                      >
                        Say Hello <i className="mi-arrow-right size-18" />
                      </a>
                    </div>
                  </div>
                  {/* End Email */}
                  ...
                  <div className="contact-item">
                    ...
                    <div>
                      <a
                        href="tel:+918899330033 "
                        className="link-hover-anim"
                        data-link-animate="y"
                      >
                        Call now <i className="mi-arrow-right size-18" />
                      </a>
                    </div>
                  </div>
                  {/* End Phone */}
